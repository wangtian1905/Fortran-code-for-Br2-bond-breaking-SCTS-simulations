...
real*8,parameter::Ip1=0.434!0.434!<the ionization potential of Br2 pi_u orbital:0.457;for Br 4p orbital: 0.434><a.u.>
...
real*8,parameter::apha_NN_Mlc=80!<polarizability of ion for considering stark shifted potential in initial state preparation><a.u.>
...
real*8,parameter::apha_II_Mlc=80!<molecular polarizability contribution for BBS ionization dynamics>atomic Br+:12;molecular ground Br2+:40;molecular stretched Br2+: 80><a.u.>
