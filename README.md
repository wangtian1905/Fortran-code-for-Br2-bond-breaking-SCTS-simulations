...
(a) create a Fortran project in VS and paste the code. <br>
(b) go to project properties of the project drop-down manu; under Fortran\Language, set "Process OpenMP Directives" to the value: "Generate Parallel Code (/Qopenmp)". <br>
(c) Under Linker\system, set values of both "Stack Reserve Size" and "Stack Commit Size" to 50000000 or higher. <br>
